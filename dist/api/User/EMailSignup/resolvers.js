...
var resolvers = {
    Mutation: {
        EmailSignUp: function (_, args) { return __awaiter(_this, void 0, void 0, function () {
            var email, existingUser, newUser, emailVerification, token, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, sendEmail_1.sendVerificationEmail(newUser.email, newUser.username, emailVerification.key)];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7:
